...
function HeroSection() {
  ...
  return (
    <section>
      <div className="relative w-full pt-40 2xl:pt-56 2xl:pb-20 pb-10 before:absolute before:w-full before:h-full before:bg-linear-to-r before:from-blue_gradient before:via-white before:to-yellow_gradient before:rounded-full before:top-24 before:blur-3xl before:-z-10 dark:before:from-dark_blue_gradient dark:before:via-black dark:before:to-dark_yellow_gradient dark:before:rounded-full dark:before:blur-3xl dark:before:-z-10">
          ...
          <div ref={ref} className="flex flex-col gap-8">
            ...
            >
              ...
              <p className="max-w-38 text-dark_black/60 dark:text-white/60">
                At Websmiths, we help small startups tackle the world’s biggest
